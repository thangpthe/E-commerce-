        ...
        <div className='p-4 sm:p-6 rounded-lg border'>
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">{new Date(orderDetails.createdAt).toLocaleDateString('vi-VN')}</p>
            </div>
            <div className="flex flex-col item-start sm:items-end mt-4 sm:mt-0">
              ...
              <span className={`${orderDetails.isDelivered ? "bg-green-100 text-green-700": "bg-red-100 text-red-700"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>{orderDetails.isDelivered ? "Delivered" : "Pending Delivery"}</span>
            </div>
          </div>
