        ...
        <div className="p-6 rounded-lg mb-6">
            ...
            <form action="" onSubmit={handleSubmit}>
                <div className="mb-4">
                    ...
                    <input type="text" name="name" value={formData.name} onChange={handleChange} id="" className='w-full p-2 border rounded' required/>
                </div>
                <div className="mb-4">
                    <label htmlFor="" className='block text-gray-700'>Email</label>
                    <input type="email" name="email" value={formData.email} onChange={handleChange} id="" className='w-full p-2 border rounded' required/>
                </div>
                <div className="mb-4">
                    <label htmlFor="" className='block text-gray-700'>Password</label>
                    <input type="password" name="password" value={formData.password} onChange={handleChange} id="" className='w-full p-2 border rounded' required/>
                </div>
                ...
                <tbody>
                    {users.map((user)=> (
                        <tr key={user._id} className='border-b hover:bg-gray-50'>
                            ...
                            <td className="p-4">
                                <select name="" id="" value={user.role} onChange={(e) => handleRoleChange(user._id,e.target.value)} className='p-2 border rounded'>
                                    <option value="customer">Customer</option>
                                    <option value="admin">Admin</option>
                                </select>
                            </td>
