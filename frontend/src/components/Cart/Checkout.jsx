...
//             id: `MOCK_PAYMENT_${new Date().getTime()}`,
//             status: "COMPLETED",
//             payer: {
...
//                     <input type="email" name="" id="" value={user? user.email: ""} className='w-full p-2 border rounded' disabled />
//                 </div>
...
//                     <input type="text" className='w-full p-2 border rounded' required value={shippingAddress.address} onChange={(e) => setShippingAddress({...shippingAddress,address: e.target.value})}/>
//                 </div>
...
//                     <input type="text" className='w-full p-2 border rounded' required value={shippingAddress.country} onChange={(e) => setShippingAddress({...shippingAddress,country: e.target.value})}/>
//                 </div>

//                  <div className="mb-4">
//                     <label htmlFor="" className='"block text-gray-700'>Phone</label>
//                     <input type="text" className='w-full p-2 border rounded' required value={shippingAddress.phone} onChange={(e) => setShippingAddress({...shippingAddress,phone: e.target.value})}/>
//                 </div>
...
const Checkout = () => {
   ...
   useEffect(() => {
       if(user) {
           dispatch(fetchCart({userId: user._id, guestId: null}));
       } else if(guestId) {
   ...
   const handleSubmitOrder = async(e) => {
        ...
        try {
            ...
            const checkoutId = checkoutRes.payload._id;
            ...
            // 4. Finalize checkout (create order)
            await axios.post(
            ...
            <form onSubmit={handleSubmitOrder}>
                ...
                <div className="mt-6">
                    ...
                    <p className="text-sm text-gray-500 text-center mt-2">
                        Payment will be simulated (Cash on Delivery)
                    </p>
                </div>
            </form>
        </div>
