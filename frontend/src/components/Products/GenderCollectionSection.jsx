    ...
    <section className='py-16 px-4 lg:px-0'>
      <div className="container mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="relative flex-1">
          <img alt='Men collection' className='w-full h-[700px] object-cover' src={womenCollectionImage}/>
         ...
         <div className="relative flex-1">
          <img alt='Men collection' className='w-full h-[700px] object-cover' src={menCollectionImage}/>
          <div className="absolute bottom-8 left-8 bg-white p-4">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">
              Men collection
            </h2>
